...
export const Navbar = ({ setMenuOpen }) => {
  ...
  return (
    <>
      {/* Mobile-only Navbar */}
      <nav className="fixed top-0 left-0 right-0 flex flex-col z-50 md:hidden">
        <div className="w-full bg-white shadow-lg">
          ...
          {/* Mobile Social Bar */}
          <div className="flex w-full items-center justify-between px-4 py-2 border-t border-gray-100 bg-white">
          ...
          <div className="w-[90%] md:w-[80%] max-w-6xl p-2 flex justify-between items-center rounded-lg">
            ...
            <div className="flex items-center space-x-4">
              <span className="flex items-center text-xs md:text-sm">
                <a href="tel:+94766581620" className="flex items-center text-gray-600 hover:text-gray-900">
                <Phone className="mr-1 w-3 h-3 md:w-4 md:h-4" /> +94 76658 1620
                </a>
              </span>
          ...
          <div className="w-[95%] sm:w-[90%] md:w-[80%] max-w-6xl p-2 flex flex-wrap justify-between items-center">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-1 sm:space-x-2">
                ...
                <span className="text-xs sm:text-sm text-gray-600"> <a href="mailto:chamodh@gmail.com" className="flex items-center text-gray-600 hover:text-gray-900">chamodh@gmail.com</a></span>
              </div>
            </div>
