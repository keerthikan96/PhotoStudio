...
const Footer = () => {
  return (    <footer className="bg-gray-900">
      ...
      <div className="relative">
        ...
        <div className="relative container mx-auto px-6 pt-16 pb-12">          {/* Newsletter Section */}
          <div className="text-center mb-16">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="max-w-md mx-auto flex flex-col sm:flex-row gap-3">
                ...
                />
                <button className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-8 py-4 rounded-full hover:from-blue-600 hover:to-purple-700 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                  Subscribe
                </button>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="flex space-x-3">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="group bg-gray-800 hover:bg-gradient-to-br hover:from-purple-500 hover:to-pink-500 rounded-xl p-3 transition-all duration-300 border border-gray-700"
                >
                  <svg className="h-5 w-5 text-gray-300 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="text-gray-300 hover:text-purple-400 transition-colors duration-200 flex items-center group cursor-pointer">
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center group">
                  <div className="bg-gray-800 group-hover:bg-purple-600 rounded-lg p-2 mr-3 transition-colors border border-gray-700">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-purple-400 group-hover:text-white transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
