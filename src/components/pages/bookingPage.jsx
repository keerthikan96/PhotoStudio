    ...
    <div id="faq" className="min-h-screen bg-[#f0f2f4] mt-10">
      <div className="flex flex-col items-center justify-center w-full mx-auto py-4 sm:py-6 md:py-8 text-gray-900">
        ...
        <div className="mx-4 md:mx-auto max-w-7xl md:w-full px-4 sm:px-6 md:px-8 bg-gray-800 text-white py-6 sm:py-8 md:py-10 text-center rounded-lg mb-8">
          ...
          <p className="text-xs sm:text-sm mt-2">Home/Make Your Enquiry</p>
          ...
          <div className="container mx-auto px-4 py-16 max-w-6xl">
                ...
                <div className="md:w-1/2 p-8 flex flex-col justify-center">
                  <div className="flex items-center mb-4">
                    ...
                    <h1 className="text-lg font-medium">
                      Discover some of the Artistic Approach Photography{" "}
                    </h1>
                  </div>
                ...
                <div className="flex mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-2">
                      This is just a simple enquiry form, click here to fill
                      out.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-2">
                      Click here to schedule your online meeting with our team.
                    </p>
                  </div>
                </div>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-2">
                      We can pack up anywhere to capture your moments.
                    </p>
                  </div>
                </div>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-2">
                      Your slots filling super fast. Book your slot as soon as
                      possible.
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg mb-10 text-center">
              ...
              <p className="text-gray-700 text-sm mb-4">
                By filling this &ldquo;Enquiry Form&rdquo; – quotation will be
                generated against the accuracy of details given by you.
              </p>
              <button className="bg-gray-800 hover:bg-gray-700 text-white font-medium py-2 px-6 rounded-md">
                Get Quote!
              </button>
            </div>
            ...
            <div className="text-center mb-10">
              ...
              <p className="text-gray-600 text-sm">
                Give us a few details for your customized quotation, our team
            ...
            <form
              ...
              className="bg-white p-8 rounded-lg shadow-lg text-left w-full"
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  ...
                  <div className="flex">
                    ...
                    <button
                      type="button"
                      className="bg-black hover:bg-gray-700 text-white font-medium px-4 py-2 rounded-r-md text-sm"
                    >
                      Verify
                    </button>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div>
                  ...
                  <div className="flex">
                    ...
                    <button
                      type="button"
                      className="bg-gray-900 hover:bg-gray-700 text-white font-medium px-3 py-2 rounded-r-md text-sm"
                    >
                      ADD
                    </button>
                  </div>
