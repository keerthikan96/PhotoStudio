...
const ContactUs = () => {
  ...
  return (
    <div id='contactus' className="min-h-screen flex flex-col py-10 sm:py-12 md:py-16 bg-gray-50 mt-16 sm:mt-20 md:mt-24">
      <div className="container mx-auto px-4 md:px-8 lg:px-16 max-w-7xl">
        <h1 className="text-3xl md:text-4xl font-bold text-center mb-8 md:mb-12">Contact Us</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 mb-10 md:mb-14 mx-auto max-w-5xl">
          <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300 flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 text-sm">Focuz Studios™<br/>#39, Second Floor, 2nd St,<br/>Thirumalai Nagar, Kolathur,<br/>Chennai, Tamil Nadu 600099</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start max-w-6xl mx-auto">
          <form className="bg-white p-6 md:p-8 rounded-2xl shadow-md lg:col-span-2" onSubmit={handleSubmit}>
            <div className="bg-black text-white inline-block px-4 py-2 rounded-lg mb-4">Contact Us</div>
            <h3 className="text-2xl font-bold mb-2">Leave a message!</h3>
            <p className="mb-6 text-gray-500">Support team will reach out as soon as possible.</p>
          ...
          <div className="space-y-4">
            <div className="bg-white p-6 rounded-2xl shadow-md">
              <button className="flex items-center gap-3 w-full text-left">
                ...
                <span className="text-sm font-medium">Get directions to our office</span>
              </button>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-md">
              <button className="flex items-center gap-3 w-full text-left">
                ...
                <span className="text-sm font-medium">Contact our support team<br/>+91 96009 01721</span>
              </button>
            </div>
