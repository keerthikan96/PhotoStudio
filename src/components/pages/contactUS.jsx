...
const ContactUs = () => {
  ...
  return (
    <div id='contactus' className="min-h-screen flex flex-col py-10 px-4 md:px-10 relative bg-[#f8f9fa] top-40">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <div className="bg-white p-6 rounded-xl shadow">
          <h2 className="text-lg font-semibold">Address</h2>
          <p className="mt-2 text-sm">Focuz Studios™<br/>#39, Second Floor, 2nd St, Thirumalai Nagar, Kolathur, Chennai, Tamil Nadu 600099</p>
        </div>
        <div className="bg-white p-6 rounded-xl shadow">
          <h2 className="text-lg font-semibold">Email</h2>
          <p className="mt-2 text-sm">hello@focuzstudios.in</p>
        </div>
        <div className="bg-white p-6 rounded-xl shadow">
          <h2 className="text-lg font-semibold">Phone</h2>
          <p className="mt-2 text-sm">+91 96009 01721</p>
        </div>
      </div>

      <div className="grid md:grid-cols-3 gap-10 items-start">
        <form className="bg-white p-6 rounded-xl shadow md:col-span-2" onSubmit={handleSubmit}>
          <h3 className="text-xl font-semibold mb-4">Leave a message!</h3>
          <p className="mb-6 text-sm text-gray-500">Support team will reach out as soon as possible.</p>
          ...
          <div className="flex gap-2 mb-4">
            <input
              ...
              required
            />
            <button type="button" className="bg-black text-white px-4 py-2 rounded" onClick={handleVerify}>
              Verify
            </button>
          </div>
        ...
        <div className="space-y-4">
          <button className="flex items-center gap-2 bg-white px-4 py-3 shadow rounded-xl w-full">
