          ...
          <RevealOnScroll>
            <div className="flex flex-col justify-center h-full">
              <p className="text-gray-600 mb-6">
                ...
                <span className="font-semibold">best wedding photographer in Chennai</span>, offering
                world-class wedding photography and cinematography services. We have captured magical
                moments from weddings both nationally and internationally, covering
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-24">
          ...
          <RevealOnScroll>
            <div className="text-center p-6 transition-all duration-300 hover:shadow-lg hover:bg-gray-50 rounded-lg">
              ...
              <h3 className="text-xl font-bold mb-3">Candid/Artistic Photography</h3>
              <p className="text-gray-600">
                Candid photography is not just about capturing moments — at Focuz Studios, it's about
                celebrating authenticity. We believe in capturing natural smiles, unposed emotions, and genuine
                interactions. Our team is trained to blend into your celebrations, approach each moment with
                creativity, and work tirelessly to help you relive those precious memories for years to come.
              </p>
            </div>
          </RevealOnScroll>
          ...
          <RevealOnScroll>
            <div className="text-center p-6 transition-all duration-300 hover:shadow-lg hover:bg-gray-50 rounded-lg">
              ...
              <h3 className="text-xl font-bold mb-3">Traditional Photography</h3>
              <p className="text-gray-600">
                Traditional wedding photography is all about timeless, formal portraits. At Focuz Studios, we
                make sure each posed moment is captured beautifully. You'll see classic, vibrant color photos
                where couples, families, and friends are looking toward the camera — all smiling and saying
                "Cheese!" These photos highlight rituals, group moments, and cultural significance, preserving
                your special day for generations.
              </p>
            </div>
          </RevealOnScroll>
          ...
          <RevealOnScroll>
            <div className="text-center p-6 transition-all duration-300 hover:shadow-lg hover:bg-gray-50 rounded-lg">
              ...
              <p className="text-gray-600">
                A wedding, we believe, is like a movie — a coming together of beautiful moments into one big happy
                story that becomes timeless. At Focuz Studios, we specialize in crafting cinematic wedding films that
                showcase emotions, traditions, and love stories with elegance. After all, isn't it important to
                capture this fairy-tale and preserve it forever!
              </p>
            </div>
          </RevealOnScroll>
        </div>
